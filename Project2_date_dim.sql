#WARNING: DO NOT implement this file before chinook_dw has been created!
...
#only dates need for this database, left a year buffer on each end
CALL PopulateDateDimension('2008/01/01', '2014/12/31');
